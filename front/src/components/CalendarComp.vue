<template>
    <div>
      <div v-if="showControls" class="d-flex flex-colum  align-center justify-center "  >
        <v-btn
          icon
          class="ma-2"
            ...
            <v-simple-table dense> 
                <tbody v-if="selectedEvent.patient">
                    ...
                    <tr>
                        ...
                        <td>{{ selectedEvent.patient.appointmentDate }} {{ selectedEvent.patient.appointmentHour }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>{{ selectedEvent.patient.patient_info.Name }} {{ selectedEvent.patient.patient_info.Last_name }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>{{ selectedEvent.patient.patient_info.PhoneNumber }} |  Enviar mensaje <v-btn icon href="https://api.whatsapp.com/send?phone=5585604475" target="_blanck">
                <!-- Enviar recordatorio -->
  ...
  export default {
    ...
    data: () => ({
      ...
      {text:'Por semana', value:'week'}, {text:'Por día', value:'day'}],
      mode: 'stack',
      modes: ['stack', 'column'],
      weekday: [1, 2, 3, 4, 5, 6],
      weekdays: [
      ...
      value: '',
      comp_events: [],
      colors: ['blue', 'indigo', 'deep-purple', 'cyan', 'green', 'orange', 'grey yellow'],
      selectedEvent: {},
    ...
    methods: {
      ...
      getEvents () {
        ...
        for (let i = 0; i < this.events.length; i++) {
              var date_min = this.events[i].appointmentDate+'T'+this.events[i].appointmentHour
